            ...
            <p>To complete this program you <b>MUST</b> follow these 3 simple rules</p>
                <ul className="rules-list">
                    ...
                    <div className="rule-item">
                      ...
                      <div className="rule-item">
                        <p><b>Weight*</b></p>
                        <p>Select the maximum weight that allows you to complete the set with goof form</p>
                    </div>
                </ul>
                <small>* The first and second set should be at 75% and 85% of your working weight used for the last two sets.</small>
                <h3>The Training Tracker</h3>
                <p>This training tracker follows this rotation</p><p><b><i>Push &rarr; Pull &rarr; Legs &rarr; Repeat </i></b></p>
                <p>Complete all of the workouts below and track your progress all along.</p>
        </>
    )
}